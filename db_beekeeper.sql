...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 09, 2024 lúc 08:07 PM
...
INSERT INTO `chamcong` (`ID_NhanVien`, `NgayChamCong`, `Checkin`, `CheckOut`, `SoGioLam`, `TrangThai`, `Thu`, `Tuan`, `TenCa`) VALUES
(54, '2024-12-16', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Hai', 50, 'Sáng'),
(54, '2024-12-17', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Ba', 50, 'Sáng'),
(54, '2024-12-18', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Tư', 50, 'Sáng'),
(54, '2024-12-19', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Năm', 50, 'Sáng'),
(54, '2024-12-20', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Sáu', 50, 'Sáng'),
(54, '2024-12-16', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Hai', 50, 'Chiều'),
(54, '2024-12-17', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Ba', 50, 'Chiều'),
(54, '2024-12-18', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Tư', 50, 'Chiều'),
(54, '2024-12-19', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Năm', 50, 'Chiều'),
(54, '2024-12-20', NULL, NULL, NULL, 'Đăng ký ca', 'Thứ Sáu', 50, 'Chiều');
...
(18, 53, 'Chân gà sốt thái', 'NhanVien', 'vasvag', 50000, 0, '2024-12-09', NULL, 'chn_g_st_thi.jpg');
...
(20, 1, 'Súp Rong Biển', '', 3, 19000, 50, 'sup_rong_bien.jpg', 0);
...
(54, 12, 1, 'Trần Văn Hải', '0123456789', 'tranvanhai@gmail.com', 0);
...
(8, 1, 8, 0, '2024-12-10'),
(9, 1, 9, 0, '2024-11-30'),
(10, 1, 10, 0, '2024-11-30'),
(11, 1, 11, 0, '2024-11-30'),
(12, 1, 12, 0, '2024-11-30'),
(13, 1, 13, 0, '2024-11-30'),
(14, 1, 14, 0, '2024-11-30'),
(15, 1, 15, 0, '2024-11-30'),
(16, 1, 16, 0, '2024-11-30'),
(17, 1, 17, 0, '2024-11-30'),
(18, 1, 18, 0, '2024-11-30'),
(19, 1, 19, 0, '2024-11-30'),
(20, 1, 20, 0, '2024-11-30'),
...
--
ALTER TABLE `danhsachdexuatmonmoi`
  MODIFY `ID_MonMoi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `danhsachyeucaubosungnguyenlieu`
--
ALTER TABLE `danhsachyeucaubosungnguyenlieu`
  MODIFY `ID_YeuCau` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `nhanvien`
  MODIFY `ID_NhanVien` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `taikhoan`
  MODIFY `ID_TaiKhoan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
