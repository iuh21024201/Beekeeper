...
$sql = "SELECT dt.ID_DatTiec, kh.HoTen, dt.ID_CuaHang, dt.GioHen, dt.TrangTri, dt.SoNguoi, dt.TongTien, dt.TienCoc, dt.TienConLai, dt.GhiChu, dt.TrangThai 
        FROM DonTiec dt
    ...
    <table class="table table-bordered mt-4">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . htmlspecialchars($row["TrangTri"]) . "</td>";
            ...
            echo "<tr><td colspan='11' class='text-center'>Không có kết quả phù hợp</td></tr>";
        }
        ?>
        </tbody>
    </table>
